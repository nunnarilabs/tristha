...
> Live artifacts live in Cowork. They can call your connected tools (e.g. Jira, Drive) on load,
> so the view is always current. Reads are cached and there's a Reload button.

## Pre-req
Have the Jira **"Demo Defects"** project from Task 5 (or Google Drive defect data) connected.

## Build it
In Cowork:
> "Create a **live artifact**: a QA status dashboard that reads my Jira 'Demo Defects' issues each
...
Open it, then change a defect in Jira, hit **Reload** in the artifact, and watch it update.
